...
export interface ApiAppointmentAppointment extends Schema.CollectionType {
  ...
  attributes: {
    ...
    >;
    Note: Attribute.Text & Attribute.Unique;
...
export interface ApiDoctorDoctor extends Schema.CollectionType {
  ...
  attributes: {
    Name: Attribute.String & Attribute.Required;
    Address: Attribute.String & Attribute.Required & Attribute.Private;
    Patients: Attribute.String & Attribute.Required & Attribute.Private;
...
export interface ApiHospitalHospital extends Schema.CollectionType {
  ...
  attributes: {
    ...
    BloodDonation: Attribute.Boolean & Attribute.Required;
    categories: Attribute.Relation<
      'api::hospital.hospital',
      'manyToMany',
      'api::category.category'
    ...
    appointments: Attribute.Relation<
      ...
      'api::appointment.appointment'
    >;
    Open: Attribute.Time & Attribute.Required;
    Close: Attribute.Time & Attribute.Required;
    doctors: Attribute.Relation<
      'api::hospital.hospital',
      'oneToMany',
      'api::doctor.doctor'
